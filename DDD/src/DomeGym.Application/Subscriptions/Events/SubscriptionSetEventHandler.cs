...
public class SubscriptionSetEventHandler : INotificationHandler<SubscriptionSetEvent>
{
    ...
    public Task Handle(SubscriptionSetEvent notification, CancellationToken cancellationToken)
        => _subscriptionsRepository.AddSubscriptionAsync(notification.Subscription);
}